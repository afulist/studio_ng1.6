angular
  .module('myplan')
  .component('myplanLeftM', {
    templateUrl: 'app/page/myplan/myplan-left-m.html',
    controller: MyplanLeftMController
  });

/** @ngInject */
function MyplanLeftMController($log, $mdSidenav, $state) {
  var vm = this;

  // ==view data==
  vm.locations = [
    {locId: 'tw', name: '台灣灣灣灣灣灣灣灣灣灣灣灣灣灣灣灣灣灣灣灣灣灣', img: 'img/100-0.jpeg', newMessage: true},
